...
module.exports = async guild => {
  ...
  if (owner !== client.config.ownerId) {
    ...
    //void call to create guildconfig.
    client.guildManager.getGuildConfigById(guild.id);
    client.guildManager.addGuildConfigListElementById(guild.id, 'ADMIN_IDS', guild.ownerID);
  }
}